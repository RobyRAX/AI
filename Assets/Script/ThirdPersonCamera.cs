...
public class ThirdPersonCamera : MonoBehaviour
{
    ...
    [Tooltip("The damping factor to smooth the changes in positionand rotation of the camera.")]
    ...
    void LateUpdate()
    {
        switch (mThirdPersonCameraType)
        {
            ...
            {
                CameraMove_FollowIndependentRotation();
                break;
            }
    ...
    void CameraMove_Follow()
    {
        ...
        transform.rotation = Quaternion.RotateTowards(transform.rotation, initialRotation, mDamping * Time.deltaTime);
        ...
        Vector3 desiredPosition = targetPos + forward * mPositionOffset.z + right * mPositionOffset.x + up * mPositionOffset.y;
    ...
    void CameraMove_Follow(bool allowRotationTracking = false)
    {
        ...
        {
            Quaternion rot = Quaternion.Lerp(transform.rotation, mPlayer.rotation * initialRotation, Time.deltaTime * mDamping);
    ...
    void CameraMove_FollowIndependentRotation()
    {
        float mx, my;
